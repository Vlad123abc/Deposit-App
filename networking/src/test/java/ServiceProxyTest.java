...
public class ServiceProxyTest {
    ...
    public void getAllPackagesTest() throws Exception {
        ...
        System.out.println("calling getAllPackages");
        List<Package> packageList = serviceProxy.getAllPackages();
        System.out.println("called getAllPackages");
        ...
        assertEquals(ResponseType.OK, sentData.getType());
        // ... add verification to see user and pass
        User user = gson.fromJson(sentData.getData().toString(), User.class);
        assertEquals(user.getUsername(), "vlad");
        assertEquals(user.getPassword(), "parola");
        ...
        assertEquals(ResponseType.OK, logoutData.getType());
    }
}
